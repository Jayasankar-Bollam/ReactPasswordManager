...
const Manager = () => {
    ...
    if (form.site.length > 3 && form.username.length > 3 && form.password.length > 3) {
        ...
        // Generate ONE id to use everywhere
        const id = form.id || uuidv4();

        // Only delete if editing an existing password (id exists)
        if (form.id) {
        ...
        // Use the same id in both state and DB
    ...
    return (
        <>
            ...
            <div className=" mycontainer p-3 md:p-0 min-h-[86.2vh]">
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <div className="flex flex-col md:flex-row flex w-full justify-between gap-8">
                    ...
                    <button onClick={savePassword} className="flex justify-center items-center gap-2 bg-green-400 hover:bg-green-300 rounded-full px-8 py-4 w-fit hover:border border-green-900">
                        <lord-icon
